    ...
    : Command
{
    ...
    public InteractiveCommand(IBookwormService bookwormService, INotifier notifier, string name, string? description = null)
            ...
            switch (selectedMenu)
            {
                case "Add a new book":
                    ...
                    if (string.IsNullOrWhiteSpace(title))
                    {
                        ...
                        _notifier.ShowMessage(MessageType.Error, ["Title cannot be null or empty."]);
                        return;
                    }
                    ...
                    if (title.Length > 50)
                    {
                        ...
                        _notifier.ShowMessage(MessageType.Error, ["Title cannot exceed 50 characters."]);
                        return;
                    }
                    ...
                    try
                    {
                        ...
                        if (result)
                        {
                            ...
                            _notifier.ShowMessage(MessageType.Info, ["Book added successfully."]);
                        }
                        else
                        {
                            Log.Warning("Book '{Title}' could not be added.", title);
                            _notifier.ShowMessage(MessageType.Warning, ["Book could not be added."]);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Remove book":
                    ...
                    try
                    {
                        ...
                        if (result)
                        {
                            ...
                            _notifier.ShowMessage(MessageType.Info, ["Book removed successfully."]);
                        }
                        else
                        {
                            Log.Warning("Book '{Title}' could not be removed.", removeTitle);
                            _notifier.ShowMessage(MessageType.Warning, ["Book could not be removed."]);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "List":
                    ...
                    else
                    {
                        ...
                        _notifier.ShowMessage(MessageType.Warning, ["No books found."]);
                    }
                    break;
                case "Export":
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            _notifier.ShowMessage(MessageType.Warning, ["No books could be exported."]);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Import":
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            _notifier.ShowMessage(MessageType.Warning, ["No books imported successfully."]);
                        }
                    }
                    catch (Exception ex)
                    {
